    ...
    <div className="storefront-app">
      <header className="storefront-header">
        <div className="header-container">
          <div className="brand" onClick={() => setActiveTab('shop')}>ECOMMERCE-ROOT-LAYOUT</div>
      ...
      <footer className="storefront-footer">
        <p>&copy; {new Date().getFullYear()} ECOMMERCE-ROOT-LAYOUT. Powering digital storefronts with clean modular architecture.</p>
      </footer>
    </div>
  );
}
